...
- NEXT_CHAT_PROMPT.md — **SYNCHRONIZED — Pass2B scans31–40 next**

## Exact next activity

Proceed with **Part001 Pass 2B — global scans31–40 / local pages31–40** as the next independent lexical / historical-glyph reread against rendered source pixels. Keep all records at `status: "needs-review"` and `visual_fidelity: "needs-review"` until the maintained promotion gates. Keep **75→76** pending until Part002 is supplied.
