...
- printed bibliographic block is headed `நூல் அளவை`;
- handwritten accession/classification-style marks overlap the middle-left of the page and are treated as later copy-specific non-body matter;
- printed wording and edition sequence are preserved without normalization;
...
- single-column bibliographic/specification block headed `நூல் அளவை` verified across the page;
- handwritten accession/classification marks overlap the middle-left but are copy-specific non-body matter;
- publication-page classification, field layout and absence of printed pagination are structurally correct;
